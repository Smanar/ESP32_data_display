...
const char *WIFI_PASSWORD = "xxxxxxxxxxxxxxxxxxxx";
...
// METEO API
const String APIKEY   = "xxxxxxxxxxxxxxxxxxxxxxxxxxxx";
const String METEO_API_ENDPOINT = "api.open-meteo.com";

// DOMOTICZ API
const String DOMOTICZ_API_ENDPOINT = "192.168.1.1";
const uint16_t DOMOTICZ_API_PORT = 8080;
const String DOMOTICZ_API_IDX = "35,124,125,13,14";
