...
extern const String METEO_API_ENDPOINT;
extern const String DOMOTICZ_API_ENDPOINT;
extern const uint16_t DOMOTICZ_API_PORT;
extern const String DOMOTICZ_API_IDX;
...
extern const int DAILY_GRAPH_MAX;
